 ...
 * @author Toshiba
 */
public class BlockCipherKeyFrame extends javax.swing.JFrame {

    /**
     * Creates new form BlockCipherKeyFrame
     */
    ...
    private void initComponents() {
        ...
        jButtonSubmit.setText("Generate Key");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BlockCipherKeyFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BlockCipherKeyFrame().setVisible(true);
            }
        });
    }
