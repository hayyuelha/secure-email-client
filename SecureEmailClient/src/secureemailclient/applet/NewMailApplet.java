 ...
 * @author Toshiba
 */
public class NewMailApplet extends javax.swing.JApplet {

    /**
     * Initializes the applet NewMailApplet
     */
    @Override
    public void init() {
...
//            java.util.logging.Logger.getLogger(NewMailApplet.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
